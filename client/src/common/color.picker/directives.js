            ...
            scope.$watch('pickerShown', function(newValue) {
              if (newValue) {
                colorPickerElement = $compile('<div color-picker-popover="model" color-picker-popover-shown="pickerShown" ' + 
                  'color-picker-popover-container=".mx-view-container>.container" color-picker-popover-target=".mx-color-picker-btn"></div>')(scope);
                element.find('.mx-color-picker-btn').parent().append(colorPickerElement);
        ...
        return {
          ...
          link: function (scope, element, attrs) {
            var windowEl = angular.element($window),
              ...
              panel = element.find('.mx-color-picker-panel'),
              arrow = element.find('.mx-color-picker-popover-arrow');           
